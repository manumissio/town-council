...
import { 
  ...
  X, ExternalLink, Info, Loader2, Database, User, Briefcase
} from "lucide-react";
 ...
 */
function ResultCard({ hit, onPersonClick }) {
  ...
  /**
   * Request a new summary from the API.
   * Why: This saves AI costs by only summarizing what you click on.
   */
