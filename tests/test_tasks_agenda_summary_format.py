...
def test_generate_summary_task_agenda_titles_use_bluf_plain_text(mocker):
    mock_db = MagicMock()
    catalog = MagicMock()
    ...
    items_query.filter_by.return_value.order_by.return_value.limit.return_value.all.return_value = [
