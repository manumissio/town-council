...
cat > "$RESULT_DIR/run_config.json" <<EOF
{
  ...
  "profile": {
    ...
    "LOCAL_AI_HTTP_API": "${LOCAL_AI_HTTP_API:-}",
    ...
    "LOCAL_AI_HTTP_TIMEOUT_SEGMENT_SECONDS": "${LOCAL_AI_HTTP_TIMEOUT_SEGMENT_SECONDS:-}",
    "LOCAL_AI_HTTP_TIMEOUT_SUMMARY_SECONDS": "${LOCAL_AI_HTTP_TIMEOUT_SUMMARY_SECONDS:-}",
    "LOCAL_AI_HTTP_TIMEOUT_TOPICS_SECONDS": "${LOCAL_AI_HTTP_TIMEOUT_TOPICS_SECONDS:-}",
    "LOCAL_AI_HTTP_MAX_RETRIES": "${LOCAL_AI_HTTP_MAX_RETRIES:-}",
    "WORKER_CONCURRENCY": "${WORKER_CONCURRENCY:-}",
    "WORKER_POOL": "${WORKER_POOL:-}",
    "OLLAMA_NUM_PARALLEL": "${OLLAMA_NUM_PARALLEL:-}",
    "INFERENCE_MEM_LIMIT": "${INFERENCE_MEM_LIMIT:-}"
  }
}
EOF
