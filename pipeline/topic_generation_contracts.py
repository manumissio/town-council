...
TOPIC_TOKEN_PATTERN = r"(?u)\b[a-zA-Z][a-zA-Z']{2,}\b"  # noqa: S105 - Parsing rule, not a secret.
PLACE_TOKEN_PATTERN = r"[a-zA-Z]{3,}"  # noqa: S105 - Parsing rule, not a secret.
FALLBACK_TOPIC_TOKEN_PATTERN = r"[a-zA-Z][a-zA-Z'-]{2,}"  # noqa: S105 - Parsing rule, not a secret.
