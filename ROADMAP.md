...
Exit criteria:
- the checked-in `baseline_representative_v2` expectation references valid,
  reproducible post-roster-gate evidence;
...
- the checked-in `baseline_representative_v2` expectation remains tied to
