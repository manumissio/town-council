...
- cleanup module families for downloader, NLP entities, segment-city CLI, hydration CLIs, models, DB migrations, indexing, semantic backends, summary text, provider/person utilities, reporting scripts, task/API/search helpers, onboarding/repair scripts, and prior facade splits stay under the 300-line target
